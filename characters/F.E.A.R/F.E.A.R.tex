...
\addWeaponStatistic{Scimitar}{F.E.A.R}{STR}{P}{0}{1d6 s}{finesse, light}
\addWeaponStatistic{Unarmed Strike}{F.E.A.R}{STR}{P}{2}{\intcalcAdd{3}{\calculateModifier{\StrengthScoreValue}} b}{}
...
\AddClassFeature{Q}{\textbf{Circle Forms}\\AC \intcalcAdd{13}{\intcalcAdd{1}{\calculateModifier{\WisdomScoreValue}}}, max CR 1, 9 temp HP}
\AddClassFeature{L}{\textbf{Form of the Dread}\\\intcalcAdd{0}{\ProficiencyValue} Uses}
\AddClassFeature{Q}{\textbf{Eldritch Invocations}\\Beguiling Influence, Eldritch Mind}
...
\AddFeat{\textbf{Dreadful Strike}\\this and that}
...
\addAttunedMagicItem{Eldritch Claw Tattoo}
