...
\CharacterAppearance{horizontal} % (vertical/horizontal/none)
	{2.5} % Main-Text Offset (Steps of 15.75 [equal to line-height])
	{0} % Picture X-Shift (absolute value, no effect in vertical mode)
	{25} % Picture Y-Shift (absolute value)
	{images/Mehen_Norixius.png} %
	{%
		Mehen Norixius is a 6'5'' tall Sapphire Gem Dragonborn. Covered in turquoise-blue scales, he radiates a sturdy but noble appearance. Nothing escapes his silvery eyes and he is always aware of his surroundings.
	}%
