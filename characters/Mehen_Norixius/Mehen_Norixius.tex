...
\Equipment{
	A staff, a hunting trap, a bear claw, a set of traveler's clothes
}
...
\OrganizationSymbol{example-image-a}
...
\FirstLevelSpellSlotB{Thunderous Smite}
\FirstLevelSpellSlotC{Wrathful Smite}
\FirstLevelSpellSlotD{Ensnaring Strike (needs Holy Symbol)}
\FirstLevelSpellSlotE{Speak with Animals (needs Holy Symbol)}
...
\textbf{Thunder - 15 ft. cone (DEX Save, DC = \intcalcAdd{8}{\intcalcAdd{\calculateModifier{\ConstitutionScoreValue}}{\ProficiencyValue}})} \\
