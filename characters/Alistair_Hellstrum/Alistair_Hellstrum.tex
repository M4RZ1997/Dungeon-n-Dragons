...
\Class{Bard}
\Subclass{\small College of Whispers / Archfey}
\Background{Courtier}
\Race{Tiefling}
%% Multiclass
...
\WeaponsProficiency{Simple Weapons, Hand Crossbows, Longswords, Rapiers, Shortswords}
\ToolsProficiency{Bagpipe, Lure, Violin}
% --------------------------------------------------------------------------------------------------------------- %
...
%%	#7 = Notes
\addWeaponStatistic{Rapier}{AlistairHellstrum}{DEX}{P}{0}{1d8 \calculateModifier{\DexterityScoreValue} p}{Finesse}
\addWeaponStatistic{Dagger}{AlistairHellstrum}{DEX}{P}{0}{1d4 \calculateModifier{\DexterityScoreValue} p}{Thrown (20/60), Finesse, Light}
% UNARMED STRIKE
\addWeaponStatistic{Unarmed Strike}{AlistairHellstrum}{STR}{P}{0}{\intcalcMax{1}{\intcalcAdd{1}{\calculateModifier{\StrengthScoreValue}}} b}{}
% DAMAGE CANTRIPS
...
%%	#6 = Damage
%%	#7 = Notes
\addSpellStatistic{Eldritch Blast}{ATK}{\calculateModifier{\CharismaScoreValue}}{1d10 \calculateModifier{\CharismaScoreValue}}{Force, 2 Beams}
\addSpellStatistic{Mind Sliver}{DC}{\calculateModifier{\CharismaScoreValue}}{2d6}{Psychic, Subtract 1d4 from next Saving Throw}
\addSpellStatistic{Mind Sliver}{DC}{\calculateModifier{\CharismaScoreValue}}{2d4}{Psychic, Disadvantage on next Attack Roll}
% --------------------------------------------------------------------------------------------------------------- %
% #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+# FEATURES AND TRAITS #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+# %
% --------------------------------------------------------------------------------------------------------------- %
...
% CLASS FEATURE
\AddClassFeature{Q}{\textbf{Bard Traits}}
\AddClassFeature{B}{\textbf{Bardic Inspiration}\\Die: d8, \intcalcAdd{0}{\calculateModifier{\CharismaScoreValue}} Uses}
\AddClassFeature{Q}{\textbf{Jack of All Trades}\\Half Proficiency to all Skills not proficient with}
\AddClassFeature{Q}{\textbf{Song of Rest}}
\AddClassFeature{L}{\textbf{Psychic Blades}\\+2d6 Psychic damage}
\AddClassFeature{L}{\textbf{Words of Terror}\\Once per Short or Long Rest}
\AddClassFeature{Q}{\textbf{Expertise}\\Performance and Persuasion Expertise}
\AddClassFeature{Q}{\textbf{Font of Inspiration}}
\AddClassFeature{Q}{\textbf{Warlock Traits}}
\AddClassFeature{Q}{\textbf{Archfey Expanded Spell List}\\Faerie Fire, Sleep}
\AddClassFeature{A}{\textbf{Fey Presence}}
% SPECIES TRAITS
\AddSpeciesFeature{Q}{\textbf{Darkvision}}
\AddSpeciesFeature{Q}{\textbf{Hellish Resistance}\\Resistance to Fire damage}
\AddSpeciesFeature{Q}{\textbf{Infernal Legacy}\\Thaumaturgy, Hellish Rebuke, and Darkness learned}
% FEATS
\AddFeat{\textbf{Eloquent Performer}\\Advantage on Performance Checks made to impress or engage a crowd}
\AddFeat{\textbf{Eldritch Adept}\\Agonizing Blast}
\AddFeat{\textbf{Charm of the Monarch}\\Fly Speed, +5 Bonus to Charisma-based Ability Checks}
\AddFeat{\textbf{Compulsion (Locket)}\\+1 Bonus to Charisma-based Ability Checks}
% --------------------------------------------------------------------------------------------------------------- %
...
\CharacterAppearance{vertical} % (vertical/horizontal/none)
	...
	{1} % Picture Y-Shift (absolute value)
	{images/Alistair_appearance.png} %
	{%
		{Alistair Hellstrum stands at an average height with a lean and agile build. His skin has a rich, deep burgundy hue, a testament to his infernal heritage as a Tiefling. His eyes}{are a striking shade of golden amber, shimmering with a mischievous glint and an air of confidence. Alistair's dark, wavy hair cascades down to his shoulders, accentuating his charismatic and somewhat untamed demeanor.}
	}%
...
\AdditionalFeaturesAndTraits{
	...
	Alistair has a talent for languages and has devoted time to learning and mastering multiple tongues. In addition to Common and Infernal, he may be fluent in Elvish, Dwarvish, or other languages he has encountered during his travels.\\
...
% --------------------------------------------------------------------------------------------------------------- %
\Equipment{
	Rapier, 2 Dagers, \textbf{Eliwick's blank sheet of paper}\\
	Leather Armor, Disguise Kit\\
	1 ruby (medium), 1 sapphire (medium), 2 silvered pine cones, Beetle in a Sweet, Cat Eye, Candy\\
	a backpack, a bedroll, 2 costumes, 5 candles, 5 days of ration, a waterskin
}
%% Attuned Magic Items (Max 3, every other is ignored)
\addAttunedMagicItem{Enchanted Locket of Lysandra}
\addAttunedMagicItem{Fochlucan Bandore}
\addAttunedMagicItem{Ring of the Feywild Dryads}
%% Gold
\CP{}
\SP{}
\EP{}
...
\addPreparedSpell{0}
	...
	{}
	{}
	{\small 1d10 \calculateModifier{\CharismaScoreValue} Force, 2 Beams}
	{V, S}
\addPreparedSpell{0}
	{Mage Hand}
	{Action}
...
\addPreparedSpell{1}
	...
	{}
	{T}
	{\footnotesize 1 Minute, no Fall Damage}
	{V, M}
\addPreparedSpell{1}
	{Healing Word}
	{Bonus Action}
	...
	{}
	{}
	{Heal 1d4 \SpellcastingModifierValue~HP}
	{V}
\addPreparedSpell{1}
	{Hellish Rebuke}
	{Reaction}
...
\addPreparedSpell{1}
	...
	{V, S, M}
\addPreparedSpell{1}
	{\footnotesize Protection from Good and Evil}
	{Action}
	{Touch}
	{T}
	{}
