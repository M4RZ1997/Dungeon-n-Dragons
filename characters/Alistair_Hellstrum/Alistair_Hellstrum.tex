...
\CantripSlotA{Prestidigitation (V, S)}
\CantripSlotB{Vicious Mockery (V)}
\CantripSlotC{Thaumaturgy (once per day) (V)}
...
\SecondLevelSpellSlotA{Shatter (V, S, M)}
\SecondLevelSpellSlotB{Suggestion (V, M)}
