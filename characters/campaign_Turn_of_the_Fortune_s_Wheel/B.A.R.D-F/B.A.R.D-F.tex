...
\addSpellStatistic{Chill Touch}{ATK}{\calculateModifier{\CharismaScoreValue}}{2d10}{Necrotic, can't regain Hit Points, CON save}
\addSpellStatistic{Vicious Mockery}{DC}{\calculateModifier{\CharismaScoreValue}}{2d6}{Psychic, Disadvantage next attack, WIS save}
\addSpellStatistic{Dissonant Whispers}{DC}{\calculateModifier{\CharismaScoreValue}}{3d6}{Psychic, must move away safely, WIS save}

\AddClassFeature{B}{\textbf{Bardic Inspiration}\\\intcalcAdd{0}{\calculateModifier{\CharismaScoreValue}} Uses, Inspiration Die: d8}
