...
\DexterityScoreBonus{1} % +1 Warforged
\ConstitutionScoreBonus{2} % +1 Warforged, +1 Durable
...
%%	#7 = Notes
\addWeaponStatistic{Acheron Blade}{B.A.R.D-F}{STR}{P}{1}{1d8 \calculateModifier{\StrengthScoreValue} s}{versatile (1d10)}
\addWeaponStatistic{Light Crossbow}{B.A.R.D-F}{DEX}{P}{0}{1d8 \calculateModifier{\DexterityScoreValue} p}{ranged (80/320), loading, two-handed}
\addWeaponStatistic{Handaxe}{B.A.R.D-F}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} s}{thrown (20/60), light}
% UNARMED STRIKE
...
\AddClassFeature{R}{\textbf{Countercharm}}
% SPECIES TRAITS
...
\AddSpeciesFeature{E}{\textbf{Specialized Design}\\Athletics Proficiency, Wargong}
...
\AddFeat{\textbf{Durable}\begin{itemize}\item Defy Death\item Speedy Recovery\end{itemize}}
...
\textit{Athletics Proficiency, Wargong Proficiency}\\
...
\paragraph*{Defy Death} You have Advantage on Death Saving Throws.
\paragraph*{Speedy Recovery} As a Bonus Action, you can expend one of your Hit Point Dice, roll the die, and regain a number of Hit Points equal to the roll.
...
\textbf{Intimidation, Perception, Persuasion, Survival}\\
...
Each creature in a 10-foot-radius Sphere centered on a point you choose within range must succeed on a Wisdom saving throw, or that target can't take Bonus Actions or Reactions and must roll 1d10 at the start of each of its turns to determine its behaviour for that turn, consulting the table below.
\begin{DndTable}{lX}
	1d10	& Behavior for the Turn \\
	1		& The target doesn't take an action, and it uses all its movement to move. Roll 1d4 for the direction: 1, north; 2, east; 3, south; 4, west.\\
	...
	9-10	& The target chooses its behaviour.
\end{DndTable}

At the end of each of its turns, an affected target repeats the save, ending the spell on itself on a success.

\subparagraph*{Using a Higher-Level Spell Slot} The Sphere's radius increases by 5 feet for each spell slot level above 4.
...
\subparagraph*{Using a Higher-Level Spell Slot} You can target one additional creature for each spell slot level above 4.
