...
%%	#7 = Notes
\addWeaponStatistic{Quarterstaff}{F.E.A.R}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} b}{versatile (1d8)}
\addWeaponStatistic{Armblade}{F.E.A.R}{STR}{P}{+1}{1d8 \calculateModifier{\StrengthScoreValue} s}{heavy}
% UNARMED STRIKE
...
\AddClassFeature{L}{\textbf{Grave Touched}\\Don't need to eat, drink, or breathe\\Rolled Damage can become Necrotic and an additional damage die while in Form of Dread}
% SPECIES TRAITS
