...
\ConstitutionScoreBonus{2} % Autognome +1, ASI +1
\IntelligenceScoreBonus{5} % Autognome +2, ASI +3
\WisdomScoreBonus{0}
...
% HIT POINTS
\MaxHitPointsRolled{43} % Without Constitution Bonus, is added automatically (44 Rolled -1 Malus throughout campaign)
...
%%	#7 = Notes
\addWeaponStatistic{Quarterstaff}{A.R.T.I.F.I.C.E.R-Beta}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} b}{versatile (1d8)}
\addWeaponStatistic{Handaxe}{A.R.T.I.F.I.C.E.R-Beta}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} s}{thrown, light}
\addWeaponStatistic{Light Crossbow}{A.R.T.I.F.I.C.E.R-Beta}{DEX}{P}{0}{1d8 \calculateModifier{\DexterityScoreValue} p}{}
% UNARMED STRIKE
...
\AddClassFeature{R}{\textbf{Flash of Genius}\\Add \calculateModifier{\IntelligenceScoreValue} to your or allies' Ability Check or Saving Throw (\intcalcAdd{0}{\calculateModifier{\IntelligenceScoreValue}} Uses)\\}
\AddClassFeature{R}{\textbf{Explosive Cannon}\\More potent Eldritch Cannon can explode on damage taken}
% SPECIES TRAITS
...
\AddSpeciesFeature{E}{\textbf{Specialized Design}\\Carpenter's and Woodcarver's Tools}
% FEATS
...
\CharacterAppearance{horizontal} % (vertical/horizontal/none)
	{7.5} % Main-Text Offset (Steps of 15.75 [equal to line-height])
...
\AlliesAndOrganizations{
	...
	The guild's primary goals include advancing the knowledge of magical\linebreak
}{and mechanical innovation, preserving Lantan's unique technological heritage, and influencing the wider world through their creations. Their relentless pursuit of progress sometimes raises ethical questions, as their experiments occasionally blur the line between invention and peril.}
...
% --------------------------------------------------------------------------------------------------------------- %
\Equipment{
	\textbf{Robe of Useful Items}, \textbf{Eyes of Minute Seeing}, \textbf{Inevitable Disabling Device}, \textbf{Potion of Gaseous Form}\\Opal Gem (100gp), Light Crossbow, 20 Bolts, Handaxe, Quarterstaff, Thieves' Tools, Dice Set, small Lantanna piece of jewellery (10gp), traveler's clothes
}
...
\begin{DndMonster}[width=0.5\textwidth]{Homunculus Servant}
    ...
    \DndMonsterDetails[
        saving-throws = {DEX +\intcalcAdd{2}{\ProficiencyValue}},
...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=1,inner sep=0pt, xshift=-2cm, yshift=-6cm] at (current page.north east){\includegraphics[width=0.175\paperwidth, keepaspectratio]{images/Homunculus_Servant.png}};
\end{tikzpicture}
...
\subparagraph*{Using a Higher-Level Spell Slot} When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd. The creatures must be within 30 feet of each other when you target them.
...
\subparagraph*{Using a Higher-Level Spell Slot} When you cast this spell using a spell slot of 4th level or higher, you can animate two additional objects for each slot level above 3rd.
