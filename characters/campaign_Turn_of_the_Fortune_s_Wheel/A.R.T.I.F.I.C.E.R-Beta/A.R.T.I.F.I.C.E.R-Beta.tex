...
\MaxHitPointsRolled{37} % Without Constitution Bonus, is added automatically (33 Rolled -1 Malus throughout campaign)
...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=1,inner sep=0pt, xshift=-2cm, yshift=-2.25cm] at (current page.north east){\includegraphics[width=0.175\paperwidth, keepaspectratio]{images/Homunculus_Servant.png}};
\end{tikzpicture}
