...
\CharismaScoreBonus{4}			% Wechselkind +1, ASI +3
...
%%	#7 = Notes
\addWeaponStatistic{Light Crossbow}{Thistlenight}{DEX}{P}{0}{1d8 \calculateModifier{\DexterityScoreValue} p}{ranged (80/320), loading, two-handed}
\addWeaponStatistic{Dagger}{Thistlenight}{DEX}{P}{0}{1d4 \calculateModifier{\DexterityScoreValue} p}{finesse, light, thrown}
% UNARMED STRIKE
\addWeaponStatistic{Unarmed Strike}{Thistlenight}{STR}{P}{0}{\intcalcMax{1}{\intcalcAdd{1}{\calculateModifier{\StrengthScoreValue}}} b}{}
% DAMAGE CANTRIPS
...
\AddClassFeature{L}{\textbf{Font of Magic}\\8 Sorcery Points}
...
\AddClassFeature{L}{\textbf{Sorcerous Restoration}\\Restore \intcalcShr{\LevelValue} Sorcery Points during Short Rest (Once per Long Rest)}
...
% SPECIES TRAITS
\AddSpeciesFeature{E}{%
	\textbf{Artificial Form}\\Healing spell affected Construct.%
	\begin{itemize}%
		\item[\CustomItemLabel{L}] \textbf{Self Repair (\intcalcAdd{0}{\ProficiencyValue} Uses)}\\Mending restores Hit Die + CON
	\end{itemize}%
}
\AddSpeciesFeature{E}{\textbf{Magical Fortification}\\Resilient against Magical Effects}
\AddSpeciesFeature{E}{\textbf{Childish Agility}\\Can move through the space of any creature that is Medium or larger and hide if half covered by those.\\Acrobatics Proficiency}
\AddSpeciesFeature{L}{\textbf{Faerie Glamour}\\Minor Illusion Cantrip\\Disguise Self once per Long Rest}
% FEATS
\AddFeat{\textbf{Feywild Connection}\\Friendly Fey are inclined to help you in the Feywild}
...
\CharacterAppearance{vertical} % (vertical/horizontal/none)
	{12}	% Main-Text Offset (Steps of 15.75 [equal to line-height])
...
\paragraph*{Self-Repair} If you take this trait twice, when the Mending cantrip is cast on you, you can spend a Hit Die to regain a number of Hit Points equal to the roll of the die plus your Constitution modifier (minimum 1 Hit Point). You can use this feature a number of times equal to your Proficiency Bonus, regaining all expended uses when you finish a Long Rest.
\subsection*{Magical Fortification}
\textit{Wisdom Saving Throws}\\
...
\subsubsection*{Intuitive Acrobat}
...
\subsubsection*{Magical Savvy (Minor Illusion)}
...
\begin{DndTable}[header=Fey Mark]{llX}
				& d8	& Fey Mark\\
	...
	\textbullet	& 6		& Flowers wilt in your presence.\\
...
\begin{DndTable}[header=Feywild Visitor]{lX}
	d8	& Visitor		\\
...
\textit{Maximum of \intcalcShr{\LevelValue} Sorcery Points}\\
...
\subparagraph*{Using a Higher-Level Spell Slot} When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1d6 for each slot level above 4th.
