...
\CharismaScoreBonus{2} % Wechselkind, ASI +1
...
\addSpellStatistic{Chromatic Orb}{ATK}{\calculateModifier{\CharismaScoreValue}}{3d8}{Acid, Cold, Fire, Lightning, Poison, or Thunder}
\addSpellStatistic{Ice Knife}{BOTH}{\calculateModifier{\CharismaScoreValue}}{1d10 p}{+ 2d6 Cold explosion, DEX save}
\addSpellStatistic{Antagonize}{DC}{\calculateModifier{\CharismaScoreValue}}{4d4}{Psychic, WIS save}
\addSpellStatistic{Vampiric Touch}{ATK}{\calculateModifier{\CharismaScoreValue}}{3d6}{Necrotic, regain half damage Hit Points}

\AddClassFeature{B}{\textbf{Innate Sorcery}\\Unleash innate magic \textbf{twice} per Long Rest}
\AddClassFeature{L}{\textbf{Font of Magic}\\5 Sorcery Points}
