...
\AttacksAdditional{
	...
	\textbf{5 Ice Arrows:}\\hit target must succeed DC 13 CON saving throw otherwise frozen for one turn, ends after 1 turn or if target takes heat damage\\
	\textbf{Boomerang Arrow} (returns to shooter)\\
