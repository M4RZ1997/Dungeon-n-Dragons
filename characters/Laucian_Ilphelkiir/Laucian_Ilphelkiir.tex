...
\AddWeapon{Oathbow}{0}{1d8 p}

\AttacksAdditional{
	\textbf{Oathbow}\\
	\textbf{Anletta's Bow}\\
	\textbf{Bracers of Trickshot}\\
	...
	\textbf{Armor:} Chain Shirt +2, Leather Armor, Magical Shield (?)\\
}
...
\indent Current Max (Normal): \intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{2}}}} \\
\indent Current Max (Sharpshooter): \intcalcSub{\intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{2}}}}}{5} \\
...
\indent Current Max (Normal): \intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{\intcalcAdd{2}{1}}}}} \\
\indent Current Max (Sharpshooter): \intcalcSub{\intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{\intcalcAdd{2}{1}}}}}}{5}
\paragraph*{Damage Roll}\hfill\\
\underline{\textit{Oathbow:}}\\
1d8 + 2 (Wedge Stone) + DEX-Modifier + 2 (Bracers of Trickshot) (+ 3d6 (against Sworn Enemy)) (+ 10 (Sharpshooter)) \\
\indent Current Max (Normal): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{2}}} \\
\indent Current Max (Sworn Enemy): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{2}}{\intcalcMul{3}{6}}}} \\
\indent Current Max (Sharpshooter): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{2}}{10}}} \\
\indent Current Max (Sharpshooter, Sworn Enemy): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{2}}{\intcalcAdd{\intcalcMul{3}{6}}{10}}}}\\
\underline{\textit{Anletta's Bow:}}\\
1d8 + 2 (Wedge Stone) + DEX-Modifier + Bow Modifier + 2 (Bracers of Trickshot) (+ 1 (Anletta's Bow: against Undead)) (+ 10 (Sharpshooter)) \\
\indent Current Max (Normal): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{1}{2}}}} \\
\indent Current Max (Undead): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcAdd{1}{2}}{1}}}} \\
\indent Current Max (Sharpshooter): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcAdd{1}{2}}{10}}}} \\
\indent Current Max (Sharpshooter, Undead): \intcalcAdd{8}{\intcalcAdd{2}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcAdd{1}{2}}{\intcalcAdd{1}{10}}}}}
