...
\Equipment{
	...
	Ruby (500 gold),
	2 Potion of Giant Size (1 x *) \\
	\textbf{
	Quiver of Ehlonna,
	Quiver of the Storm's Fury,
	Wand of Secrets}
	}
}
...
\Treasure{
	\textbf{1. Cloak of the Forest Guardian:} A finely woven cloak made from enchanted moss and leaves. When worn, it grants Laucian the ability to blend seamlessly with his surroundings, rendering him nearly invisible in natural environments. It also provides him with enhanced stealth and evasion abilities.\\
...
1d20 + DEX-Modifier + 2 $\times$ Proficiency Modifier (Expertise) + 2 (Fighting Style: Archer) + 2 (Bracers of Trickshot) + 2 (Quiver of the Storm's Fury) (- 5 (Sharpshooter)) \\
\indent Current Max (Normal): \intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{\intcalcAdd{2}{2}}}}} \\
\indent Current Max (Sharpshooter): \intcalcSub{\intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\intcalcMul{2}{\ProficiencyValue}}{\intcalcAdd{2}{\intcalcAdd{2}{2}}}}}}{5} \\
