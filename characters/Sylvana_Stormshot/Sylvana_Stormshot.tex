...
% Weapon Arsenal
\AddWeapon{Longbow}{0}{1d8 p}
\AddWeapon{Rapier}{0}{1d8 s}
...
\CharacterAppearance{}{
	\hspace*{-1.65em}\begin{tabular}{p{120pt}p{50pt}}
		\begin{tabular}{p{90pt}}\vspace*{-1.25em}\includegraphics[width=120pt, height=140pt, keepaspectratio]{images/Sylvana_Stormshot.png}\end{tabular}
		&
		\hspace*{-1.6em}\begin{tabular}{>{\raggedleft}p{53pt}}Sylvana Stormshot is a graceful Owlin with beige feathers that provide excellent forest camouflage.\linebreak \end{tabular}
	\end{tabular}\\\vspace*{-1.6em}\hfill\\
	Her forest-green eyes reflect keen perception, and she's often seen in a flowing blue kimono adorned with nature-inspired patterns. She carries an air of quiet confidence, embodying the harmony of natural beauty and arcane power.
}{}{}{}
...
\indent Current Max (Normal): \intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\ProficiencyValue}{2}}} \\
\indent Current Max (Sharpshooter): \intcalcSub{\intcalcAdd{20}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{\intcalcAdd{\ProficiencyValue}{2}}}}{5}\\
...
\indent Current Max (Shadow Arrow):\\\indent\indent\intcalcAdd{8}{\calculateModifier{\DexterityScoreValue}} + \intcalcMul{2}{6} Psychic Damage \\
\indent Current Max (Sharpshooter): \intcalcAdd{8}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{10}} \\
\indent Current Max (Sharpshooter, Shadow Arrow):\\\indent\indent\intcalcAdd{8}{\intcalcAdd{\calculateModifier{\DexterityScoreValue}}{10}} + \intcalcMul{2}{6} Psychic Damage
...
\indent Current Max (Normal): \intcalcAdd{20}{\intcalcAdd{\calculateModifier{\StrengthScoreValue}}{\ProficiencyValue}}
\paragraph*{Damage Roll}\hfill\\
1d6 + STR-Modifier \\
