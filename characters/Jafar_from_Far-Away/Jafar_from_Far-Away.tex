...
% Headline
\CharacterName{Jafar from Far-Away}
...
\Speed{30ft}
\MaxHitPointsRolled{10} % Without Constitution Bonus, is added automatically
\CurrentHitPoints{}
\TemporaryHitPoints{}
\HitDice{d6}
\HitDiceSpent{0}
...
% Weapon Arsenal
\addWeaponStatistic{Weapon1}{JafarfromFarAway}{DEX}{P}{0}{1d6 p}
\addWeaponStatistic{Weapon1}{JafarfromFarAway}{DEX}{P}{0}{1d10 b}
