...
\addWeaponStatistic{Chill Touch}{Thistlenight}{CHA}{P}{0}{1d10}{Necrotic, target can't regain hit points}
\addWeaponStatistic{Infestation}{Thistlenight}{CHA}{P}{0}{1d6}{Poison, must move if able}
\addWeaponStatistic{Mind Sliver}{Thistlenight}{CHA}{P}{0}{1d6}{Psychic, 1d4 malus on next saving throw}
\addWeaponStatistic{Chromatic Orb}{Thistlenight}{CHA}{P}{0}{3d8}{Acid, Cold, Fire, Lightning, Poison, or Thunder}
\addWeaponStatistic{Ice Knife}{Thistlenight}{CHA}{P}{0}{1d10 p}{+ 2d6 Cold explosion (DEX save)}
...
\Treasure{
	\textbf{Amber Necklace} A tarnished bronze chain holds a smooth amber stone with a tiny, frozen insect trapped within. Worn and weathered, it radiates a faint warmth, as if it holds a quiet, hidden power. Thistlenight treasures it as the last remnant of their old life.\\
	\textbf{8-Inch Glass Ant Figurine} This delicate glass ant, eerily lifelike, catches light in faint rainbow hues. A small crack mars one of its legs, yet its weight feels oddly grounding in Thistlenight's hand.\\
	\textbf{Silver Fork with Bent Tines} A tarnished silver fork with its outer tines bent sideways, bearing a faint, nearly illegible engraving. Its imperfections make it oddly compelling, and Thistlenight keeps it as an inexplicable token of resilience.
}
