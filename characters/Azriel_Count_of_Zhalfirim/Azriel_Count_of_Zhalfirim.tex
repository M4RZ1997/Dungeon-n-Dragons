...
% Weapon Arsenal
\addWeaponStatistic{Rapier}{AzrielCountofZhalfirim}{DEX}{P}{0}{1d6 p}
\addWeaponStatistic{Crossbow}{AzrielCountofZhalfirim}{DEX}{P}{0}{1d8 p}
\addWeaponStatistic{Claws}{AzrielCountofZhalfirim}{DEX}{P}{0}{1d6 s}

\AttacksAdditional{
	\textbf{Bite}\\
	\indent 1d6 + \intcalcAdd{\calculateModifier{\ConstitutionScoreValue}}{0} necrotic damage\\
	\textbf{Rapier of Life Stealing}\\
	Crossbow (80/320), 20 Crossbow Bolts
}
...
\CantripSlotA{Faerie Fire (V)}
\CantripSlotB{Mage Hand (V, S)}

\FirstLevelSpellSlotsTotal{2}
\FirstLevelSpellSlotA{Detect Poison and Disease (V, S)}
\FirstLevelSpellSlotB{Fog Cloud (V, S)}
\FirstLevelSpellSlotC{Speak with Animals (V, S)}
