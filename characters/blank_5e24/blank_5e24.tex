...
%%	#7 = Notes
\addWeaponStatistic{Quarterstaff}{Test}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} b}{Versatile (1d8)}
\addWeaponStatistic{Handaxe}{Test}{STR}{P}{0}{1d6 \calculateModifier{\StrengthScoreValue} s}{Thrown, Light}
\addWeaponStatistic{Light Crossbow}{Test}{DEX}{P}{0}{1d8 \calculateModifier{\DexterityScoreValue} p}{}
...
% CLASS FEATURE
\AddClassFeature{A}{\textbf{Class Feature I}\begin{itemize}
	\item[\CustomItemLabel{B}] Bonus Action
	\item No Specification
\end{itemize}}
\AddClassFeature{Q}{\textbf{Class Feature II}\\this and that}
% SPECIES TRAITS
\AddSpeciesFeature{L}{\textbf{Species Feature I}\\this and that}
% FEATS
...
\Skin{}
\Hair{}
\CharacterAppearance{vertical} % (vertical/horizontal/full-size/none) !Full-Size will distort image to fit entire field!
...
% --------------------------------------------------------------------------------------------------------------- %
\Equipment{
	Greatsword, 12 Javelins, Longbow, 20 Arrows\\
