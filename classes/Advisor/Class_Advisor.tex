...
\usepackage{\PATH templates/template_class/class_commands}

\usepackage{\PATH templates/utilities/ornamented}

\ClassName{Advisor}

\begin{document}
	% Titlepage	
	\classesTitlePage{The Advisor}
		{images/titlepage_Advisor.jpg}
		{0cm}
		{-2cm}
		{width=\paperwidth}
		{https://www.artstation.com/artwork/arZ4R}
		{Piri Reis}
		{Guan Ye Chen}
	
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=north east, xshift=4cm] at (current page.north east){\includegraphics[height=0.5\paperheight, keepaspectratio]{images/Advisor(1).png}};
		\node[opacity=1,inner sep=0pt, xshift=6cm, yshift=-1cm] at (current page.center){\includegraphics[height=0.5\paperheight, keepaspectratio]{images/Advisor(2).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor1}{Page \thepage}{Background Art}{https://cdn.artstation.com/p/assets/images/images/000/697/528/large/tj-foo-grand-library.jpg?1431011034}{Grand Library}{TJ Foo}
	\addImageDBEntry{Advisor2}{Page \thepage}{Character Art}{https://www.behance.net/gallery/54878727/Empires-in-ruins-Main-Characters}{Empires in Ruins - Main Characters}{Konrad Langa}
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south east, yshift=-0.5cm, xshift=-1cm] at (current page.south east){\includegraphics[width=0.5\paperwidth, keepaspectratio]{images/Advisor(3).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor3}{Page \thepage}{Art}{https://www.artofmtg.com/art/kambal-consul-of-allocation/}{Kambal, Consul of Allocation MtG Art from Kaladesh}{Vincent Proce}
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south west, yshift=0.4cm, xshift=0cm] at (current page.south west){\includegraphics[width=0.525\paperwidth, keepaspectratio]{images/Advisor(4).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor4}{Page \thepage}{Art}{https://www.artofmtg.com/art/combat-research/}{Combat Research MtG Art from Dominaria United}{Justine Cruz}
	\vfill\eject
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south west, yshift=-1.5cm, xshift=0cm] at (current page.south west){\includegraphics[width=\paperwidth, keepaspectratio]{images/Advisor(5).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor5}{Page \thepage}{Art}{https://www.artofmtg.com/art/rob-the-archives/}{Rob the Archives MtG Art from Streets of New Capenna}{Steve Argyle}
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south east, yshift=0cm, xshift=15cm] at (current page.south east){\includegraphics[height=\paperheight, keepaspectratio]{images/Advisor(6).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor6}{Page \thepage}{Art}{https://www.artofmtg.com/art/general-kudro-of-drannith/}{General Kudro of Drannith MtG Art from Ikoria}{Ryan Pancoast}
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south west, yshift=-0.35cm, xshift=-0.15cm] at (current page.south west){\includegraphics[width=0.55\paperwidth, keepaspectratio]{images/Advisor(7).png}};
	\end{tikzpicture}
	\addImageDBEntry{Advisor7}{Page \thepage}{Art}{https://www.artofmtg.com/art/gods-willing/}{Gods Willing MtG Art from Theros}{Mark Winters}
	\vfill\eject
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[opacity=1,inner sep=0pt, anchor=south east, yshift=1cm, xshift=2cm] at (current page.south east){\includegraphics[width=0.65\paperwidth, keepaspectratio]{images/Advisor(8).png}};
	\end{tikzpicture}
	
	% Final Page
	\classesLastPage{images/backcover_Advisor.jpg}
		{0cm}
		{5cm}
		{height=\paperheight}
		{https://www.artstation.com/artwork/JvenZa}
		{The Enchanted Bibliotheca}
		{Nathanial Gibbs}
		{Created by Xcelar8 on GMBinder}
\end{document}