...
%			challenge				= -,
		...
		\DndMonsterAction{Action Surge (1 / Short Rest or Long Rest)}
		...
		When Angus McFife makes a Charisma (Intimidation, Performance, or Persuasion) check he can expend and add one Superiority Die to the roll.
...
%			plus-dmg-type	= Poison,
			...
			extra			= {. When Angus hits the target, that creature has Disadvantage on its next attack roll before the start of Angus's next turn},
		]
...
%			or-dmg			= \DndDice{1d20},
%			or-dmg-when		= {},
			extra			= {. When Angus hits the target, it must succeed on a DC 13 Constitution Saving Throw or be knocked prone},
		]
...
%			or-dmg-when		= {},
		...
		When Angus McFife takes the Attack Action he can forego his attack and use his Bonus Action to command another companion to strike. That creature takes its Reaction to make an attack, adding an expended Superiority Die to the attack's damage roll on a hit.
		
		\DndMonsterAction{Second Wind (3 charges)}
		Angus McFife regains \DndDice{1d10 + 7} Hit Points. Additionally, he can move up to half his speed without provoking Opportunity Attacks.
		...
		\DndMonsterReaction[%
			name		= Riposte, 
			trigger 	= {A creature misses Angus McFife with a melee attack.},
			response	= {Angus McFife expends a Superiority Die to immediately attack that creature, adding the Superiority Die to the attack's damage roll on a hit.},
		]%
	\end{multicols}
\end{DndMonster}