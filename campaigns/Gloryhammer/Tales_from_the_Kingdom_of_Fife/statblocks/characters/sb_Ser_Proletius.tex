...
%			or-dmg-when		= {},
		...
		\DndMonsterAction{Turn the Tide}
		...
		\DndMonsterReaction[%
			name = {Interception},
			trigger = {Ser Proletius sees a creature hit another creature within 5 feet of him with an attack roll.},
			response = {He reduces the damage taken by \DndDice{1d10 + 4}}
		]
		
		\DndMonsterReaction[%
			name = {Divine Allegiance},
			trigger = {A creature within 5 feet of Ser Proletius takes damage.},
			response = {Ser Proletius magically substitutes his own health for that of the creature, causing that creature not to take the damage. Instead, Ser Proletius takes the damage. This damage to him can't be reduced or prevented in any way.}
		]
	\end{multicols}
\end{DndMonster}