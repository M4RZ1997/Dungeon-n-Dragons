...
%		extra			= {},
	...
	\DndMonsterSavingThrowEffect[
		name = {Deadly Leap},
		description = {The bulette spends 5 feet of movement to jump to a space within 15 feet that contains one or more Large or smaller creatures},
		save_skill = {Dexterity},
		save_dc = {15},
		targets = {each creature in the bulette's destination space},
