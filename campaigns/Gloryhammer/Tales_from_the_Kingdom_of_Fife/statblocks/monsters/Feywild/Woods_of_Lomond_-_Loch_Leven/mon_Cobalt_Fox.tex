...
%		condition-immunities = {frightened, poisoned},
	...
	The Cobalt Fox can innately cast the following spells, without any components. Its spellcasting ability is Wisdom (spell save DC 13):
	\begin{itemize}
...
%		condition-immunities	= {frightened, poisoned},
	...
	\DndMonsterAction{Innate Spellcasting}
	The Zircon Fox can innately cast the following spells, without any components. Its spellcasting ability is Wisdom (spell save DC 15):
	\begin{itemize}
...
%		or-dmg-when=,
	...
	\DndMonsterSavingThrowEffect[
		...
		save_dc = {16},
		targets = {one creature within 30 feet of the fox},
		failure = {\DndDice{4d8 + 8} Psychic damage and the target is Frightened by the Zircon fox until the start of the fox's next turn},
