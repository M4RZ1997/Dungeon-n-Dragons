...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]%
		...
		\begin{scope}[scale=0.25, xshift=-4cm, yshift=-110cm]			
			...
			\draw[line width=3pt, red] (2,40) -- (8,43) -- (16,40) -- (40,42) -- (42,53.5) -- (44,53) -- (47,63) -- (42,57) -- (41,59) -- (39,59) -- (39,56);
			...
			\subIndicatorNumberField[10]{(39,56)}{\IndicatorSize}\indicatorAddition[!]{(39,56)}{\IndicatorSize};
