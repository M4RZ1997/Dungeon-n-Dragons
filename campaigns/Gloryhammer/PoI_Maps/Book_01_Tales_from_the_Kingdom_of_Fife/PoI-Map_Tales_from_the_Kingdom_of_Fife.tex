...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]%
		\node[opacity=1, inner sep=0pt, xshift=4.5cm, yshift=1.3cm] at (current page.center){\includegraphics[width=12.65in, keepaspectratio]{Kingdom_of_Fife_Map.png}};%
		
		% 0 - 110
		\begin{scope}[scale=0.25, xshift=-4cm, yshift=-110cm]	
			% Wall of Force
			\draw[line width=2pt, black] (102,117) arc[start angle=0, end angle=-180, radius=40];
					
			% Travel Routes
			%% September 14th 992 A.D
			\draw[line width=3pt, purple] (70,95) -- (78,78);
			%% September 15th 992 A.D
			\draw[line width=5pt, purple] (78,78) -- (85,75) -- (95,60); 
			\draw[line width=3pt, purple] (95,60) -- (88,63);
			%% September 17th 992 A.D
			\draw[line width=3pt, blue] (95,60) -- (73,58) -- (50,47) -- (63,50);
			%% September 18th 992 A.D
			\draw[line width=5pt, blue] (50,47) -- (40,42) -- (16,40) -- (8,43) -- (2,40);
			%% September 19th 992 A.D
			\draw[line width=3pt, blue] (2,40) -- (8,43) -- (16,40) -- (40,42) -- (42,53.5) -- (44,53) -- (47,63);
			%% September 20th 992 A.D
			\draw[line width=3pt, blue] (47,63) -- (42,57) -- (41,59) -- (39,59) -- (39,56);
			%% September 21st 992 A.D
			\draw[line width=3pt, red] (47,63) -- (55,70);
			%% September 22nd 992 A.D
			\draw[line width=3pt, red] (55,70) -- (64,66) -- (78,78) -- (85,75) -- (95,60);
			\draw[line width=3pt, red, dash pattern={on 10pt off 4pt on 2pt off 4pt}] (95,60) -- (5,80) -- (18,106);
			
			% Known PoIs
			\pgfmathsetmacro{\IndicatorSize}{15*\scaleFactor}%
			\indicatorAlphField[10]{(70,95)}{\IndicatorSize}; % Dundee
			\indicatorAlphField[10]{(95,60)}{\IndicatorSize}\indicatorAddition[!]{(95,60)}{\IndicatorSize}; % Citadel of Crail
			...
			\indicatorNumberField[10]{(82,78)}{\IndicatorSize}\indicatorAddition[$\times$]{(82,78)}{\IndicatorSize};
			\indicatorNumberField[10]{(88,63)}{\IndicatorSize}\indicatorAddition[$\checkmark$]{(88,63)}{\IndicatorSize};
			\indicatorNumberField[10]{(47,63)}{\IndicatorSize}\indicatorAddition[!]{(47,63)}{\IndicatorSize};
			\subIndicatorNumberField[10]{(39,56)}{\IndicatorSize}\indicatorAddition[$\checkmark$]{(39,56)}{\IndicatorSize};
			\indicatorNumberField[10]{(55,70)}{\IndicatorSize}\indicatorAddition[$\checkmark$]{(55,70)}{\IndicatorSize};
			\indicatorNumberField[10]{(2,40)}{\IndicatorSize}\indicatorAddition[$\swarrow$]{(2,40)}{\IndicatorSize};
			\indicatorNumberField[10]{(63,50)}{\IndicatorSize}\indicatorAddition[$\checkmark$]{(63,50)}{\IndicatorSize};
			\indicatorNumberField[10]{(13,110)}{\IndicatorSize}\indicatorAddition[?]{(13,110)}{\IndicatorSize};
		\end{scope}
	\end{tikzpicture}%
	\clearpage
	\eject \pdfpagewidth=12in \pdfpageheight=13.75in \thispagestyle{empty}
	\begin{tikzpicture}[remember picture, overlay]%
		\node[opacity=1, inner sep=0pt, xshift=4.45cm, yshift=3.5cm] at (current page.center){\includegraphics[width=12.05in, keepaspectratio]{Map_of_Caledonia.png}};%
		...
		\begin{scope}[scale=0.25, xshift=-4cm, yshift=-110cm]
			...
			\indicatorAlphField[10]{(77,100)}{\IndicatorSize}; % Kingdom of Unst
			...
			\indicatorNumberField[10]{(69,40)}{\IndicatorSize}\indicatorAddition[?]{(69,40)}{\IndicatorSize};
		\end{scope}
	\end{tikzpicture}%
	\clearpage
	...
	\inTextCircled[10]{F}{10} {\entryfont Kingdom of Unst}
	...
	\subsection*{Landmarks and Smaller Towns}
	...
	\inTextCircled[10]{3a}{10} {\entryfont Lochleven Castle ("Water Castle")}\\
	...
	\inTextCircled[10]{6}{10} {\entryfont Ravenscraig Castle}\\
	\inTextCircled[10]{7}{10} {\entryfont The Path to Glory / Temple of the Ancients}\\
\end{document}