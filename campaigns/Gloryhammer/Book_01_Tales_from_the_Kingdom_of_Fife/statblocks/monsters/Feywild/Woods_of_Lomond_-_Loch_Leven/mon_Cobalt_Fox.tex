...
%		extra=,
	...
	\begin{DndMonsterSpells}
		\item[Innate Spellcasting] The Cobalt Fox can innately cast the following spells, without any components. Its spellcasting ability is Wisdom (Spell Save DC 13):
...
\nopagebreakchapter{\hspace*{\columnwidth + 20pt}Cobalt Fox}\phantomsection\addcontentsline{toc}{subsection}{Cobalt Fox}\label{monster:CobaltFox}
...
% Monster stat block
\vspace*{-180pt}\begin{DndMonster}[width=0.5\textwidth +0.5em]{Zircon Fox\phantomsection\label{monster:ZirconFox}}
