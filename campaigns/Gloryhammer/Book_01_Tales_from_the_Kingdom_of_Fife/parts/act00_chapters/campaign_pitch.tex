...
{\entryfont\begin{itemize}
	...
	\item \textbf{Fife, but not as you know it}\\Familiar lands twisted by strange disappearances, eerie omens, and forces that defy expectation.
\end{itemize}}
\vfill\eject
\subsection*{Factions}
...
\begin{tikzpicture}[remember picture, overlay]
	\node[yshift=2cm] at (current page.south) {\entryfont You are among those drawn into this unfolding legend - whether as nobles, mercenaries, scholars, or wanderers};
	\node[yshift=1.5cm] at (current page.south) {\entryfont your actions may decide the fate of Fife.};
\end{tikzpicture}