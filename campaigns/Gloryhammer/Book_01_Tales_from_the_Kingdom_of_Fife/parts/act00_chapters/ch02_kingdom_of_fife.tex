...
\begingroup\parfillskip=0pt Yet, as the kingdom prepared for the joyous event, whispers began to surface of strange occurrences in the mountainous regions beyond the river Tay. There were scattered sightings of the kingdom's famed unicorns - creatures known for their gentle nature and their gleaming, pure white coats - behaving in ways that unsettled those who saw them. Normally kind\par\endgroup}
\onecolumn
\begin{multicols}{2}
{\entryfont\noindent and serene, these unicorns were seen acting erratically - skittish and aggressive, fleeing from human contact. Stranger still were reports of unicorns with unusual, festering wounds that never seemed to heal, wounds that glowed with an eerie, unnatural light. Their once-brilliant fur had grown dull and dirty, as though corrupted by a dark and malevolent force.
...
\DndDropCapLine{C}{\entryfont aledonia is a realm of countless powers, where kingdoms, orders, and ancient enclaves shape the world through might, magic, and invention. From frost-bound mountains to mist-shrouded isles, from hidden elven cities to roaring dwarven forges, each faction pursues its own vision of strength, honour, or dominion.}

{\entryfont The following factions represent the major powers of Caledonia. Players may choose one of these as part of their character's origin or background.}
\subsection*{Kingdom of Fife}
\vspace*{-0.3\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	\begin{tabular}[t]{@{}p{\linewidth}@{}}
%	\hspace*{-1.2em}\begin{tabular}[t]{p{0.325\textwidth}}
		{\entryfont The Kingdom of Fife, ruled by King Dundax \RoyalRoman{XIII} and his heir Prince Angus McFife, dominates eastern Caledonia from its thousand-year-old capital of Dundee - founded by the legendary hero Dundax himself. Here, noble warriors train\linebreak}
	\end{tabular}
	&
...
\vspace*{-0.7\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	...
	\end{tabular}
\end{tabular}
\vspace*{-1.6\fontdimen6\font}\hfill\\{\entryfont ancient rites and druidic magic. To be chosen as one of their number is a rare honour, marking one as a guardian of Crail's skies and a spiritual link between the city and its soaring protectors. Their wisdom and prestige echo far beyond the citadel walls, earning them respect throughout the Kingdom of Fife.}
...
\vspace*{-0.7\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	...
	\end{tabular}
\end{tabular}
\vspace*{-1.6\fontdimen6\font}\hfill\\{\entryfont hammer out blades and plate mail famed for near-living responsiveness. Each weapon whispers with elemental wards - arrows that fly truer, swords that shatter curses, armour that hardens at a touch - earning them renown among knights and mercenaries alike.}
...
\vspace*{-0.7\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	...
	\end{tabular}
\end{tabular}
\vspace*{-1.6\fontdimen6\font}\hfill\\{\entryfont waters, and crushed gemstone dust into elixirs and ales of astonishing power. Their draughts can mend shattered bones, sharpen the mind's edge, or unleash berserker strength - each batch a guarded masterpiece. To them, the halflings and humans who stagger from their taverns in awed reverence prove that magic's greatest gift is not tempered steel but the spirit it kindles.}
...
\vspace*{-0.8\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	...
	\end{tabular}
\end{tabular}
\vspace*{-1.6\fontdimen6\font}\hfill\\{\entryfont oaks. By moonlight, vine-woven bridges connect their lantern-lit platforms, where druids known as Leafwardens tend whispering groves and coax sap to heal broken branches. They trade rare healing herbs and bow wood for tools and medicine, though no iron crosses their sacred thresholds. Governed by a moon-lit Council of Bark and Moon, the Sylvani move in silent harmony with the forest's breath - fierce guardians of every leaf and root.}
...
\vspace*{-0.4\fontdimen6\font}\hfill\\\begin{tabular}{@{}p{0.3175\textwidth}p{0.1325\textwidth}}
	\begin{tabular}[t]{@{}p{\linewidth}@{}}
	...
	\end{tabular}
\end{tabular}
\vspace*{-1.6\fontdimen6\font}\hfill\\{\entryfont sentinels, and inventions that blur flesh and steel. At its head stands the Mecha-Lord - once a master artificer now encased in enchanted iron - and his heir, the Robot Prince, a sentient bronze construct powered by elemental cores. Together they guide Auchtertool as the kingdom's unrivaled nexus of magical innovation and mechanical marvels.}
