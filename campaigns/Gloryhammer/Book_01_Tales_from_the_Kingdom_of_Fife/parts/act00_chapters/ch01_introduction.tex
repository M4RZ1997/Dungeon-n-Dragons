\chapter*{Introduction}\stepcounter{chapter}\phantomsection\addcontentsline{toc}{chapter}{Introduction}
...
\subsection*{The Specifics}\phantomsection\addcontentsline{toc}{subsection}{The Specifics}
{\entryfont \noindent }

\section*{Where to Start}\phantomsection\addcontentsline{toc}{section}{Where to Start}
{\entryfont \noindent }