...
\begin{DndQuestHook}[width=0.5\textwidth - 4pt]{Sewer Plague}
	...
	The cellar is damp, rank, and far more disturbed than a simple rat infestation would suggest. Cracked stonework and widened drainage tunnels lead into the sewers below, where the stench of rot and sickness intensifies. As the party investigates, they are set upon by a small swarm of diseased vermin - several rats, some visibly bloated and sickly, attack in erratic bursts of aggression.

	Moments later, the true source of the disturbance reveals itself: a hulking \hyperref[monster:OtyughSewerPlague]{\LinkFont{Otyugh}} lurking within the sewer chamber beyond. Drawn by the constant flow of refuse - and recently empowered by strange alchemical run-off - the creature lashes out with its tentacles, using the infected rats as both scavengers and living vectors of disease. The confined space, slick surfaces, and choking filth make the encounter especially dangerous, as the creature attempts to grapple prey and drag them into the muck while the plague-ridden rats harry the party from all sides.

	Though defeating the creature halts the immediate threat, signs of unnatural contamination remain. Strange, discoloured sludge flows through the sewer channels, carrying the acrid scent of failed alchemy. Following its source leads toward Crail's citizen ward, where two reckless apprentice wizards have been disposing of their failed experiments into the sewers - unwittingly creating the conditions for this outbreak.}
\end{DndQuestHook}
