...
\end{tikzpicture}%
\vspace*{-3\fontdimen6\font}\hfill\\\begin{multicols}{2}%
	...
	Born the eldest son of King Dundax \RoyalRoman{XIII}, Angus was raised in princely halls of Dundee but still kept his humility and kindness towards the people of Fife. His voice is warm and low, each word chosen with gentle precision; when he laughs - a rich, infectious sound - it feels like sunlight breaking through canopy leaves.
	...
	\end{DndComment}
\end{multicols}%
\vspace*{-3.3\fontdimen6\font}\hfill\\
\input{statblocks/characters/sb_Angus_McFife}%
\clearpage
\section*{Dread-Witch Queen of Cellardyke}\phantomsection\addcontentsline{toc}{section}{Dread-Witch Queen of Cellardyke}\label{char:Dread-WitchQueenOfCellardyk}%
\input{statblocks/characters/sb_Dread-Witch_Queen_of_Cellardyke}%
\clearpage
...
\subsection*{Alasdair MacLeod}\phantomsection\addcontentsline{toc}{subsection}{Alasdair MacLeod}\label{char:AlasdairMacLeod}
...
\vfill\eject
\subsection*{Ewan MacRae of Dunkeld}\phantomsection\addcontentsline{toc}{subsection}{Ewan MacRae of Dunkeld}\label{char:EwanMacRae}
...
\vfill\eject
\subsection*{Gavin Buchanan}\phantomsection\addcontentsline{toc}{subsection}{Gavin Buchanan}\label{char:GavinBuchanan}
{\entryfont Gavin Buchanan is a nimble halfling rogue from Dundee's bustling harbour district, where he learned to ghost through alleyways and lift purses with a rakish grin. His keen green eyes spot every coin pouch and councillor's secret, and his leather jerkin hides tools for any trick. In the wedding tourney, he aims to prove that wit and speed can outmatch steel - and maybe pocket a few unexpected prizes along the way.}
\input{statblocks/characters/sb_Gavin_Buchanan}
\vfill\eject
\subsection*{Hamish "Halfwit" McGregor}\phantomsection\addcontentsline{toc}{subsection}{Hamish "Halfwit" McGregor}\label{char:HamishMcGregor}
...
\vfill\eject
\subsection*{Rory MacTavish}\phantomsection\addcontentsline{toc}{subsection}{Rory MacTavish}\label{char:RoryMacTavish}
...
\onecolumn
\section*{Duncan Mac Braith (Warlock of Lochleven)}\phantomsection\addcontentsline{toc}{section}{Duncan Mac Braith (Warlock of Lochleven)}\label{char:DuncanMacBraith}%
\vspace*{-2.4\fontdimen6\font}\hfill\\\begin{multicols}{2}%
	{\noindent\entryfont Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nullam eget felis eget nunc lobortis mattis aliquam faucibus. Dictumst quisque sagittis purus sit. Mattis nunc sed blandit libero volutpat sed cras ornare. Blandit cursus risus at ultrices mi tempus imperdiet. Et netus et malesuada fames ac turpis egestas maecenas. Nibh cras pulvinar mattis nunc sed blandit. Varius vel pharetra vel turpis nunc eget lorem dolor. Tellus orci ac auctor augue. Nulla aliquet enim tortor at auctor urna nunc id cursus. A condimentum vitae sapien pellentesque habitant morbi tristique. Viverra suspendisse potenti nullam ac tortor. Quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor. Nisl condimentum id venenatis a. Dui nunc mattis enim ut tellus elementum sagittis.}
\end{multicols}%
\input{statblocks/characters/sb_Duncan_Mac_Braith}
\newpage
