...
\begin{tikzpicture}[remember picture, overlay]%
	\node[xshift=0.55\columnwidth, yshift=-0.35\paperheight] at (current page.center) {\includegraphics[width=1.6\columnwidth]{%
...
At other times, the crossbow's power manifests more tangibly. From the point of impact, writhing tentacles of brine-soaked shadow erupt, coiling around the target to restrain them or lashing violently. Witnesses say these manifestations leave behind a lingering dampness, as though something vast and unseen briefly reached through.}
...
\begin{itemize}
	...
	\item While attuned this weapon can be used as a spellcasting focus and any spell cast through it gains a +1 bonus to spell attack and spell DC.
