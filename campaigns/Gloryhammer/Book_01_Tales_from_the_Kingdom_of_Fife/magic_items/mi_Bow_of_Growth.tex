...
\begin{tikzpicture}[remember picture, overlay]%
	\node[xshift=0.7\columnwidth, yshift=-0.375\paperheight, rotate=-60] at (current page.center) {\includegraphics[width=0.9\columnwidth]{%
...
\begin{itemize}
	...
	\item A creature hit with this weapon must succeed on a DC 13 Constitution Saving Throw or is Poisoned until the start of your next round
...
\begin{itemize}
	...
	\item The Poison damage dealt by attacks with this weapon increases to 1d6 and the Save DC increases to 15.
