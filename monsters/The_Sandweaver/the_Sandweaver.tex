...
\begin{DndMonster}[float*=b,width=\textwidth +8pt]{Ancient Sandweaver}
    \begin{multicols}{2}\DndMonsterType{Gargantuan monstrosity, unaligned}
    ...
    \DndMonsterAttack[
      ...
      %or-dmg=,
      %or-dmg-when=,
      extra={. The target must make a DC 20 Constitution saving throw, taking \DndDice{8d6 + 16} poison damage on failed save, or half as much damage on a successful one. On a failure, the target is poisoned},
    ]
