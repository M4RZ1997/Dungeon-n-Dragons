...
\MonsterGraphicAndShortInfo{7.8cm}{-1.5cm}{25}{15em}%
{%
...
}{1cm}{375pt}{images/The_Sandweaver.png}%
...
\MonsterVariant{0.5em}{images/The_Sandweaver_variant.png}{Sandwidow}{%
	...
	\DndMonsterAction{Hit Points} \DndDice{15d10 + 66}
	...
	The Sandwidow spits venom in a 40 foot line that is 5 feet wide. Each creature in that line must make a DC 15 Constitution saving throw, taking \DndDice{3d8 + 6} poison damage on a failed save, or half as much on a successful one.
}%
...
\begin{DndMonster}[width=0.5\textwidth]{Giant Sandweaver}
    ...
    \DndMonsterAttack[
      ...
      %or-dmg=,
      %or-dmg-when=,
      extra={. The target must make a DC 15 Constitution saving throw, taking \DndDice{4d6} poison damage on failed save, or half as much damage on a successful one. On a failure, the target is poisoned},
    ]
    ...
    \DndMonsterAttack[
      ...
      %or-dmg=,
      %or-dmg-when=,
      extra={Any target within the radius is restrained by webbing. As an action, the restrained target can make a DC 13 Strength check, bursting the web on a success. The webbing can also be attacked and destroyed (AC 19; HP 7; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage)},
    ]
