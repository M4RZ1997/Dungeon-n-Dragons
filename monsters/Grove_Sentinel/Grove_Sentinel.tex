...
\twocolumn[\section*{\entryfont Grove Sentinel}]
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[below left=30pt and 1.25cm of posSW, anchor=south west] (cornerSW) {%
		\begin{minipage}{\paperwidth}%%
        	\centering\includegraphics[width=\paperwidth, height=300pt]{images/Sentinel_Forest_1.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
\vspace*{-20cm}\hspace*{6cm}\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
		\node (picture) at (0,0) {\includegraphics[width=\columnwidth -2em, height=250pt, keepaspectratio]{images/Grove_Sentinel_Sproutling.png}};%
\end{tikzpicture}%

\newpage

\vspace*{-2cm}\begin{center}\begin{tikzpicture}%
	\node (picture) at (0,0) {\includegraphics[width=0.5\textwidth, height=225pt, keepaspectratio]{images/Grove_Sentinel_Armor.png}};%
...
\begin{DndMonster}[width=0.5\textwidth]{Grove Sentinel (Armor)}
	...
	The Grove Sentinel makes two slam attacks.
	...
	The Grove Sentinel (Armor) assumes a defensive stance, gaining temporary immunity to critical hits and advantage on saving throws against spells. This effect lasts for 1 minute.
...
\end{DndMonster}
\vspace*{-1.2cm}\begin{center}\begin{tikzpicture}%
		\node (picture) at (0,0) {\includegraphics[width=\columnwidth, height=180pt, keepaspectratio]{images/Grove_Sentinel_Strength.png}};%
...
\MonsterBannerGraphic%
	...
	{images/Sentinel_Forest_2.png}% image to be displayed as a banner
...
% Monster stat block
\vspace*{-4.5cm}\begin{DndMonster}[float*=b,width=\textwidth +8pt]{Ancient Grove Sentinel}
	...
	\DndMonsterAction{Multiattack}
	The Ancient Grove Sentinel makes two slam attacks.
    ...
    \DndMonsterAction{Unyielding Bulwark (3/Day)}
	The Ancient Grove Sentinel assumes a defensive stance, gaining temporary immunity to critical hits and advantage on saving throws against spells. This effect lasts for 1 minute.
...
\vspace*{1.5cm}\begin{center}\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	\node (picture) at (0,0) {\includegraphics[width=0.5\textwidth, height=180pt, keepaspectratio]{images/Ancient_Grove_Sentinel.png}};%
\end{tikzpicture}\end{center}%
