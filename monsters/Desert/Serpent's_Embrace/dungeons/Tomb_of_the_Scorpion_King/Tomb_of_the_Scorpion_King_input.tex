...
\twocolumn[\section*{Dungeon Outlay}\bigskip
...
\begin{tikzpicture}[outer sep=0pt, inner sep=0pt, every shadow/.style={opacity=.8,fill=black}]
	\node {\includegraphics[width=\paperwidth - 8pt, height=14cm]{\PATH monsters/stylesheets/images/dungeon_map.png}};
	...
	\begin{scope}[scale=0.3]
		...
		\node[inner sep=0pt,outer sep=0pt,clip,rounded corners=0.5cm] {{\transparent{0.7}\includegraphics[width=\paperwidth-150pt, height=9cm]{\PATH monsters/stylesheets/images/sand_dungeon_texture.jpg}}};
		...
		-- ++(15,0) -- ++(0,26) -- ++(3,0) -- ++(0,-6) arc[start angle=-180, end angle=0, radius=1] arc[start angle=90, end angle=15, radius=4] -- ++(6.275,0)  arc[start angle=-195, end angle=-270, radius=4] -- ++(2,0) -- ++(0,7) -- ++(2,0) -- ++(0,-1) -- ++(1,0) -- ++(0,3) -- ++(3,0) -- ++(0,-5) -- ++(-1,0) -- ++(0,4) -- ++(-1,0) -- ++(0,-3) -- ++(-1,0) -- ++(0,-21) -- ++(-24,0) -- ++(0,-5)
		-- (28,-16) -- (28,16) -- (-28,16) -- cycle;
		
		\node[inner sep=0pt,outer sep=0pt,clip,rounded corners=0.5cm] at (0,0) {{\transparent{0.7}\includegraphics[width=\paperwidth-150pt, height=9cm]{\PATH monsters/stylesheets/images/rocky_dungeon_texture.jpg}}};
		
		\path[clip, drop shadow] (-28,-16)
		-- ++(15,0) -- ++(0,5) -- ++(11,12) -- ++(0,2) -- ++(-2,0) -- ++(0,6) -- ++(6,0) -- ++(0,-6) -- ++(-2,0) -- ++(0,-2) -- ++(11,-12) -- ++(0,-5) 
		-- (28,-16) -- (28,16) -- (-28,16) -- cycle;
		
		\node[inner sep=0pt,outer sep=0pt,clip,rounded corners=0.5cm] at (0,0) {\includegraphics[width=\paperwidth-150pt, height=9cm]{\PATH monsters/stylesheets/images/sandstone_dungeon_texture.jpg}};		
	\end{scope}
	...
	\begin{scope}[scale=0.3]
		...
		\node[inner sep=0pt, outer sep=0pt, anchor=south] at (-1,1) {\includegraphics[width=0.6cm, height=0.15cm]{\PATH monsters/stylesheets/images/wooden_door_texture.jpg}};
	\end{scope}
	
	% Outer Ornaments
	\begin{scope}
		\node[inner sep=0pt,outer sep=0pt, xshift=-0.5\paperwidth+130pt] {\includegraphics[height=6cm]{Scorpion_Golden_Ornament.png}};
		\node[inner sep=0pt,outer sep=0pt, xshift=0.5\paperwidth-130pt, rotate=180] {\includegraphics[height=6cm]{Scorpion_Golden_Ornament.png}};
	\end{scope}
\end{tikzpicture}
\end{minipage}}]
