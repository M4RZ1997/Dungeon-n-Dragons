...
\begin{DndMonster}[width=0.5\textwidth]{Hemovoric Venomite}
	...
	The Hemovoric Venomite can attack with both its mouths, making two separate bite attacks targeting the same creature in a single turn.
...
\vspace*{-18.75cm}\hspace*{6.5cm}\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
