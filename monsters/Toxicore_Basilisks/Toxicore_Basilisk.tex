...
\twocolumn[\section*{\entryfont Toxicore Basilisk}]
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[below left=30pt and 1.25cm of posSW, anchor=south west] (cornerSW) {%
		\begin{minipage}{\paperwidth}%%
        	\centering\includegraphics[width=\paperwidth, height=300pt]{images/Toxic_Forest.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
% Monster stat block
\vspace*{3cm}\begin{DndMonster}[width=0.5\textwidth]{Toxicoreling}
...
\vspace*{-17cm}\hspace*{5.75cm}\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
		\node (picture) at (0,0) {\includegraphics[width=1.2\columnwidth, height=280pt, keepaspectratio]{images/Toxicoreling.png}};%
\end{tikzpicture}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[above left=30pt and 5.2cm of posN, anchor=north] (cornerNW) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=1.3\columnwidth, height=280pt, keepaspectratio]{images/Scythera_Basilisk.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[below right=30pt and 4.4cm of posS, anchor=south] (cornerSE) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=1.3\columnwidth, height=250pt, keepaspectratio]{images/Bladescale_Basilisk.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
\MonsterFooterGraphic{100pt}% offset for text to bottom
	...
	{images/Toxic_Forest(2).png}% image to be displayed as a banner
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[above right=35pt and 10cm of posN, anchor=north east] (cornerNE) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=1.1\columnwidth, height=280pt, keepaspectratio]{images/Vishgraz_Toxicore_Basilisk.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
