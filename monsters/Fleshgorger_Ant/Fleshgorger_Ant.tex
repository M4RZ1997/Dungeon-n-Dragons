...
\twocolumn[\section*{\entryfont Giant Fleshgorger Ant}]
...
\MonsterGraphicAndShortInfo%
	{17.75cm}{5.75cm}% Position of Mini-Info-Box relativ to bottom left corner
	{0}% rotation of Mini-Info-Box
	...
	{-10cm}% offset of picture to bottom of page
...
\vspace*{-2.75cm}\begin{center}\begin{tikzpicture}%
	\node (picture) at (0,0) {\includegraphics[width=\columnwidth -2em, height=190pt, keepaspectratio]{images/Soldier_Ant.png}};%
