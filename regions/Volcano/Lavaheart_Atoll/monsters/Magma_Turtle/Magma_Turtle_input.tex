\graphicspath{{./images},{./monsters/Magma_Turtle/images}}

\MonsterSheetGeometry

% --------------------------------------------------------------------------------------------------- %
% ################################################################################################### %
% #-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#  Monster-Sheet with Footer Picture  #-#-#-#-#-#-#-#-#-#-#-#-#-#-#-# %
% ################################################################################################### %
% --------------------------------------------------------------------------------------------------- %

\MonsterFooterGraphic{0pt}% offset for text to bottom
	{250pt}% max height of the image
	{Magma_Turtle_Hatchling.png}% image to be displayed as a banner
	{}% used for keepaspectratio for image ({} or {, keepaspectratio})
\addImageDBEntry{MagmaTurtle1}{Page \thepage}{Art}{https://www.artstation.com/artwork/larDJ}{Lava Turtle}{Edu Suarez}%
	
\nopagebreakchapter{Magma Turtle}
\phantomsection\addcontentsline{toc}{chapter}{Magma Turtle}
...
\MonsterFooterGraphic{50pt}% offset for text to bottom
	...
	{Magma_Fields.png}% image to be displayed as a banner
	{}% used for keepaspectratio for image ({} or {, keepaspectratio})
\addImageDBEntry{MagmaTurtle2}{Page \thepage}{Background Art}{https://www.tumblr.com/mirageart/96617897518/searing-blaze}{Searing Blaze MtG Art from Worlwake}{James Paick}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[above left=20pt and 6cm of posN, anchor=north] (cornerNW) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=1.1\columnwidth, height=280pt, keepaspectratio]{Magma_Turtle_Waterform.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
\addImageDBEntry{MagmaTurtle3}{Page \thepage}{Waterform Art}{https://www.deviantart.com/davesrightmind/art/Magma-Turtle-Final-834429187}{Magma Turtle}{Davesrightmind}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[above left=20pt and 6cm of posN, anchor=north] (cornerNW) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=1.1\columnwidth, height=280pt, keepaspectratio]{Magma_Turtle_Waterform_above.png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[below right=-90pt and 6.85cm of posS, anchor=south] (cornerSE) {%
		\begin{minipage}{\columnwidth}%%
        	\centering\includegraphics[width=\columnwidth, height=180pt, keepaspectratio]{Magma_Turtle_Landform(2).png}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
\addImageDBEntry{MagmaTurtle4}{Page \thepage}{Landform Art}{https://www.deviantart.com/davesrightmind/art/Tokyo-SOS-Hi-Kame-854083060}{Tokyo-SOS-Hi-Kame}{Davesrightmind}%
