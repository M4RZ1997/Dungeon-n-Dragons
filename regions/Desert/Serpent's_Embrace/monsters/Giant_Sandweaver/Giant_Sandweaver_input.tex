...
\phantomsection\addcontentsline{toc}{chapter}{Giant Sandweaver}
...
\phantomsection\addcontentsline{toc}{section}{Ancient Sandweaver Lair}
...
\begin{DndMonster}[float*=b,width=\textwidth +8pt]{Ancient Sandweaver}
    \vspace*{-18pt}\begin{multicols}{2}\vspace*{-9pt}\hfil\\\DndMonsterType{Gargantuan monstrosity, unaligned}
...
\vfill\eject
\subsection*{Lair Actions}\vspace*{-0.5\fontdimen6\font}
\textcolor{bgtan}{\DndMonsterAction{Passive Effect: Legendary Malevolence}}\\
