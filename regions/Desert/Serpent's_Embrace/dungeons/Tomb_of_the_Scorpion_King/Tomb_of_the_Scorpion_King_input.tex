\graphicspath{{./images},{./dungeons/Tomb_of_the_Scorpion_King/images}}
...
\clearpage
\section*{History}
\phantomsection\addcontentsline{toc}{section}{History}

\clearpage

\twocolumn[\section*{Entrance Area (Outside)}
\phantomsection\addcontentsline{toc}{section}{Entrance Area (Outside)}
\vspace*{-1em}\centerline{\begin{minipage}{\paperwidth}
\begin{tikzpicture}[outer sep=0pt, inner sep=0pt, every shadow/.style={opacity=.8,fill=black}]
	\node {\includegraphics[width=\paperwidth - 8pt, height=14cm]{\PATH  templates/utilities/images/backgrounds/dungeon_map.png}};
	...
	\begin{scope}[scale=0.3]
		...
		\node[inner sep=0pt,outer sep=0pt,rounded corners=0.5cm,opacity=0.7] {
			{
				\includegraphics[width=\paperwidth-150pt, height=9cm]{
					\PATH templates/utilities/images/backgrounds/sand_dungeon_texture.jpg
				}
			}
		};
		...
		\node[inner sep=0pt,outer sep=0pt,rounded corners=0.5cm,opacity=0.7] at (0,0) {%
			{%
				%\transparent{0.7}
				\includegraphics[width=\paperwidth-150pt, height=9cm]{%
					\PATH templates/utilities/images/backgrounds/rocky_dungeon_texture.jpg%
				}%
			}%
		};%
		...
		\node[inner sep=0pt,outer sep=0pt,clip,rounded corners=0.5cm] at (0,0) {%
			\includegraphics[width=\paperwidth-150pt, height=9cm]{%
				\PATH templates/utilities/images/backgrounds/sandstone_dungeon_texture.jpg%
			}%
		};%	
	\end{scope}
	...
	\begin{scope}[scale=0.3]
		...
		% Numbers
		\pgfmathsetmacro{\IndicatorSize}{5}%
		\indicatorNumberField[10]{(-1,-3)}{\IndicatorSize}
		\indicatorNumberField[10]{(-5,-5)}{\IndicatorSize}
		\indicatorNumberField[10]{(-2.5,1)}{\IndicatorSize}
		\indicatorNumberField[10]{(1,-10)}{\IndicatorSize}
		\indicatorNumberField[10]{(9.5,7)}{\IndicatorSize}
		\indicatorNumberField[10]{(11.5,8.5)}{\IndicatorSize}
		\indicatorNumberField[10]{(9,11)}{\IndicatorSize}
		\indicatorNumberField[10]{(-12.5,8.5)}{\IndicatorSize}
	\end{scope}
...
{\entryfont
	...
	\begin{itemize}
		...
		Stone Drop Trap (DEX DC 14) that deals \DndDice{2d10} bludgeoning damage on a failed save.
...
{\entryfont
	...
	\begin{tikzpicture}
		\handwrittenNote{\linewidth}{18}{note_parchment_background_vertical.png}{%
...
\phantomsection\addcontentsline{toc}{section}{Scorpion's Gaze}
{\entryfont
...
{\entryfont
	...
	As tension thickens, a chorus of roars and growls pierces the air. From shadowed crevices and hidden corners emerges a Manticore, accompanied by \DndDice{1d4} Ebony Scarabs. Its intentions shrouded in malice, the monster embodies the very essence of danger that lurks within the tomb. A battle unfolds, and the clash of steel and the echoes of spells become a dance of survival against the backdrop of the plateau's commanding vista.
...
\phantomsection\addcontentsline{toc}{section}{Entrance Area (Inside)}