...
\begin{tikzpicture}[outer sep=0pt, inner sep=0pt, every shadow/.style={opacity=.8,fill=black}]
	\node {\includegraphics[width=\paperwidth - 8pt, height=14cm]{\PATH templates/template_dungeon/backgrounds/dungeon_map.png}};
	...
	\begin{scope}[scale=0.3]
		...
		\node[inner sep=0pt,outer sep=0pt,rounded corners=0.5cm,opacity=0.7] {
			{
				\includegraphics[width=\paperwidth-150pt, height=9cm]{
					\PATH templates/template_dungeon/backgrounds/sand_dungeon_texture.jpg
				}
			}
		};
		...
		\node[inner sep=0pt,outer sep=0pt,rounded corners=0.5cm,opacity=0.7] at (0,0) {%
			{%
				%\transparent{0.7}
				\includegraphics[width=\paperwidth-150pt, height=9cm]{%
					\PATH templates/template_dungeon/backgrounds/rocky_dungeon_texture.jpg%
				}%
			}%
		};%
		...
		\node[inner sep=0pt,outer sep=0pt,clip,rounded corners=0.5cm] at (0,0) {%
			\includegraphics[width=\paperwidth-150pt, height=9cm]{%
				\PATH templates/template_dungeon/backgrounds/sandstone_dungeon_texture.jpg%
			}%
		};%	
	\end{scope}
