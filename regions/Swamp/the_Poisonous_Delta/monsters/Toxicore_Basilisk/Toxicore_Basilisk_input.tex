...
\phantomsection\addcontentsline{toc}{chapter}{Toxicore Basilisk}
...
\vspace*{-17cm}\hspace*{5.75cm}\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt]%
		\node[xshift=-15pt] (picture) at (0,0) {\includegraphics[width=1.2\columnwidth, height=280pt, keepaspectratio]{Toxicoreling.png}};%
\end{tikzpicture}%
...
\begin{DndMonster}[width=0.5\textwidth +0.5em]{Bladescale Basilisk}
    ...
    \DndMonsterAction{Steelhide}
    The Bladescale Basilisk has resistance to piercing, slashing, and bludgeoning damage from nonmagical attacks that aren't silvered.
    
    \DndMonsterAction{Keen Senses}
    The Bladescale Basilisk has advantage on Wisdom (Perception) checks that rely on sight or smell.
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	...
	\node[above left=30pt and 4.7cm of posN, anchor=north] (cornerNW) {%
...
% Monster stat block
\vspace*{-1.3cm}\begin{DndMonster}[width=0.5\textwidth]{\Large{Vishgraz, the Toxicore Basilisk}}
    \DndMonsterType{Huge Abomination, chaotic evil}
    ...
    \DndMonsterAction{Steelhide}
    Vishgraz has resistance to piercing, slashing, and bludgeoning damage from nonmagical attacks that aren't silvered.
    
    \DndMonsterAction{Keen Senses}
    Vishgraz has advantage on Wisdom (Perception) checks that rely on sight or smell.
