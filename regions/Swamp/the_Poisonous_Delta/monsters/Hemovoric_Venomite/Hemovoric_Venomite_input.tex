...
\phantomsection\addcontentsline{toc}{chapter}{Hemovoric Venomite}
...
\vspace*{-1.3cm}\begin{DndMonster}[width=0.5\textwidth]{Scourge of Necrosis}
    \DndMonsterType{Medium Swarm of Small Monstrosities, neutral evil}
...
\phantomsection\addcontentsline{toc}{section}{Venomite Lair}
