...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=1,inner sep=0pt, xshift=-2.9cm, yshift=-2.25cm] at (current page.north east){\includegraphics[width=0.25\paperwidth, keepaspectratio]{\PATH adventures/Penguins_of_Madagascar/characters/images/Mort.png}};
\end{tikzpicture}
