...
\Speed{20}
\MaxHitPointsRolled{58} % Without Constitution Bonus, is added automatically
\CurrentHitPoints{}
\TemporaryHitPoints{}
\HitDice{d10}
\HitDiceSpent{0}
...
\FeaturesTraits{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Ambush
			\item Commanding Presence
			\item Grappling Strike
...
\CharacterAppearancePicture{\PATH adventures/Penguins_of_Madagascar/characters/images/Skipper.png}
