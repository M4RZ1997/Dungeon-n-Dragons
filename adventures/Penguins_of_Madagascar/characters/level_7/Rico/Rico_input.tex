...
\Speed{40*}
\MaxHitPointsRolled{56} % Without Constitution Bonus, is added automatically
\CurrentHitPoints{}
\TemporaryHitPoints{}
\HitDice{d12}
\HitDiceSpent{0}
...
\FeaturesTraits{
	...
	\begin{itemize}
		...
		\item Danger Sense
		\item Primal Path (Wild Magic)
		\begin{itemize}
			\item Magic Awarness
			\item Wild Surge
			\item Bolstering Magic
		\end{itemize}
		\item Extra Attack
		\item Fast Movement
		\item Feral Instinct
...
\CharacterAppearancePicture{\PATH adventures/Penguins_of_Madagascar/characters/images/Rico.png}
...
\end{DndTable}
\textbf{Spell Save DC: \intcalcAdd{8}{\intcalcAdd{\calculateModifier{\ConstitutionScoreValue}}{\ProficiencyValue}}}
\subsubsection*{Bolstering Magic}
