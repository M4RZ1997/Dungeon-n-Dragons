% BOOLEAN FOR IMAGE ON CHARACTER SHEET
\newcommand{\boolCharacterSheetImage}{false}

% MACRO FOR INPUT-GENERATION
\newcommand{\FeaturesAndSpells}{}

% HEADER BACKGROUND COLOR AND OPACITY
%\newrgbcolor{header-background-color}{0.87058824 0.87450981 0.87450981}
\newrgbcolor{header-background-color}{0.78 0.82 0.82}
\newrgbcolor{background-grey-color}{0.78 0.82 0.82}
...
\newrgbcolor{spell-sheet-fireball-color}{0.7 0.1 0.1}
\newrgbcolor{spell-sheet-fireball-color2}{1 0.5 0}
...
% Textcolor for Light Grey Text
\newrgbcolor{grey_text_color}{0.5 0.55 0.55}