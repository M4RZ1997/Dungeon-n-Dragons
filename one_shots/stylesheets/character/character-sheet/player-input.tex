...
% SAVING THROWS
\StrengthSavingThrowModifier{\calculateSavingThrow{\StrengthModifierValue}{\StrengthProficiencyValue}}
...
% SKILLS
\AcrobaticsSkillModifier{\calculateSavingThrow{\DexterityModifierValue}{\AcrobaticsProficiencyValue}}
...
\rput[cc]( 57.99946577,256.785460244){\Large \entryfont{%
	...
	{%
		\intcalcAdd{10}{\intcalcAdd{\tempModifier}{\intcalcAdd{\WisdomModifierValue}{\ProficiencyValue}}}%
	}%
	{%
		\ifthenelse{\equal{\PerceptionProficiencyValue}{E}}%
		{%
			\intcalcAdd{10}{\intcalcAdd{\tempModifier}{\intcalcAdd{\WisdomModifierValue}{\intcalcMul{\ProficiencyValue}{2}}}}%
		}%
		{%
			\intcalcAdd{10}{\intcalcAdd{\tempModifier}{\WisdomModifierValue}}%
		}%
	}%
}}%
...
\rput[lt](296,550){\parbox[b][390pt][c]{167pt}{%
	\begin{minipage}[b][\height][c]{\linewidth}
    \centering
	\includegraphics[height=390pt, width=167pt, keepaspectratio]{\CharacterAppearancePictureValue}
	\end{minipage}
}}