...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=1,inner sep=0pt, xshift=-2.9cm, yshift=-2.1cm] at (current page.north east){\includegraphics[width=0.25\paperwidth, keepaspectratio]{\PATH one_shots/Penguins_of_Madagascar/characters/images/Mort.png}};
\end{tikzpicture}
\vspace*{2cm}
