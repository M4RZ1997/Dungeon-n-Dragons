...
\addWeaponStatistic{Shortbow}{KingJulien}{DEX}{P}{+2}{1d6 p (80/320)}
...
\FirstLevelSpellSlotB{Ensnaring Strike (V)}
\FirstLevelSpellSlotC{Entangle (V, S) (1x free per long rest)}
...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=1,inner sep=0pt, xshift=-2.9cm, yshift=-2.25cm] at (current page.north east){\includegraphics[width=0.25\paperwidth, keepaspectratio]{\PATH one_shots/Penguins_of_Madagascar/characters/images/Mort.png}};
\end{tikzpicture}
