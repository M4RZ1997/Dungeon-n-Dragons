	...
	\node[xshift=-0.05cm, yshift=-0.05cm, anchor=south west, anchor=south west] at (current page.south west) {%
		\begin{minipage}{\paperwidth}%%
        	\centering\includegraphics[width=\paperwidth, height=325pt]{%
        		\PATH one_shots/Penguins_of_Madagascar/operation_Smile_and_Wave/images/monsters/Giant_Flytrap.png
        	}%
      	\end{minipage}%
	};%
\end{tikzpicture}%
...
\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt, path fading=fade down]%
	\node[xshift=7.75cm, yshift=11.5cm] at (current page.center) {
		\includegraphics[height=5cm, keepaspectratio]{%
			\PATH one_shots/Penguins_of_Madagascar/operation_Smile_and_Wave/images/monsters/Giant_Flytrap(2).png
		}
	};
\end{tikzpicture}%
			...
			\vspace*{-23pt}\hfill\\\hspace*{-22pt}\begin{tikzpicture}%
				\node at (-5,0) {%
					\includegraphics[height=120pt, keepaspectratio]{%
						\PATH one_shots/Penguins_of_Madagascar/operation_Smile_and_Wave/images/Moto-Moto.png%
					}%
				};%
				\node at (-0.5,-1) {%
					\includegraphics[width=0.85\linewidth, keepaspectratio]{%
						\PATH one_shots/Penguins_of_Madagascar/operation_Smile_and_Wave/images/Moto-Moto(2).png%
					}%
				};%
...
\clearpage%
\phantomsection\addcontentsline{toc}{section}{Private}\CharacterSheetInput[spellcasting=true]{level_3}{Private}
\clearpage
